function newEvaluationPage(options) {
    ...
    const technicalLevelElements = {
        title: 'Technical Level', headers: ['Trainee', 'Junior', 'Middle', 'Senior'],
        columnData: [
            { inputLevels: ['trainee'], },
    ...
    const textareaSectionElements = [{
        header: 'Should the candidate be hired?', placeholder: 'The type of project that is suitable for the candidate. &#10; Is guidance required for the candidate'
    }, {
        header: 'General Impression', placeholder: '*required'
    }, {
        header: 'Workflow, Leadership &amp; Soft Skills', placeholder: 'Describe the environment in which the candidate works. &#10; Describe any guidance or management experience.',
    }];
...
function textareaSection(options = {}) {
    return `
        ${textarea({ header: 'Should the candidate be hired?', placeholder: 'The type of project that is suitable for the candidate. &#10; Is guidance required for the candidate', })}
        ${textarea({ header: 'General Impression', placeholder: '*required', })}
        ${textarea({
            header: 'Workflow, Leadership &amp; Soft Skills', placeholder: 'Describe the environment in which the candidate works. &#10; Describe any guidance or management experience.',
        })}
    `;
...
const technicalLevelElements = { title: 'Technical Level', headers: ['Trainee', 'Junior', 'Middle', 'Senior'],
 columnData: [
                     {          inputLevels: ['trainee'],  },
...
${textarea({header: 'General Impression',placeholder: '*required',})}
    ${textarea({header: 'Workflow, Leadership &amp; Soft Skills',placeholder: 'Describe the environment in which the candidate works. &#10; Describe any guidance or management experience.',
})}
`;
}
